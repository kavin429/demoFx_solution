...
<head>
  ...
  <style>
    ...
    h1{ font-size:85px; }
    .star { position:absolute; width:2px; height:2px; background:#fff; right:0; animation:starTwinkle 3s infinite linear; }
    .astronaut img { width:100px; position:absolute; top:75%; animation:astronautFly 6s infinite linear; }
    button.home-btn{ margin-top:20px; padding:10px 25px; border:none; border-radius:10px; background: #8b5cf6; color:white; font-size:16px; font-weight:600; cursor:pointer; transition:0.3s; }
    button.home-btn:hover{ transform:scale(1.05); background:#a97dfc; }
/* Footer */
    footer{ position:absolute; bottom:10px; width:100%; text-align:center; color:rgba(255,255,255,0.6); font-size:14px; }
    @keyframes astronautFly{ 
        0%{ left:-100px; } 
        25%{ top:65%; transform:rotate(30deg); } 
        50%{ transform:rotate(45deg); top:70%; } 
        75%{ top:75%; transform:rotate(30deg); }
...
<div class="text">
  ...
  <button class="home-btn" onclick="window.location='/'">Go Home</button>
</div>
