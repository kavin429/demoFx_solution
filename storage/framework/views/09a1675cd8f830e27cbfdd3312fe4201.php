...
<p class="who-text">
  ...
  DemoFX Solution delivers advanced online trading services to clients worldwide.
    ...
    <!-- Right Side Image -->
    <div class="who-image">
      <img src="<?php echo e(asset('pics/about1.png')); ?>" alt="About Tradefxm">
    </div>
  </div>
</section>
...
<section class="highlights-section">
  <div class="container grid-cards">
    ...
    <div class="card fade-in row-card">
      ...
      <div class="card-row">
        <img src="<?php echo e(asset('pics/a33.png')); ?>" alt="Financial Products">
        <div class="card-copy">
          <p>
    ...
    <div class="card fade-in row-card">
      ...
      <div class="card-row reverse">
        <img src="<?php echo e(asset('pics/a55.png')); ?>" alt="Customer Satisfaction">
        <div class="card-copy">
          <p>
    ...
    <div class="card fade-in row-card">
      ...
      <div class="card-row">
        <img src="<?php echo e(asset('pics/a4.png')); ?>" alt="Our Team">
        <div class="card-copy">
          <p>
    ...
    <div class="card fade-in row-card">
      <h3>Technology</h3>
      <div class="card-row reverse">
        <img src="<?php echo e(asset('pics/a3.png')); ?>" alt="Technology">
        <div class="card-copy">
          <p>
...
<?php /**PATH C:\projects\demo_solutions\resources\views/about.blade.php ENDPATH**/ ?>