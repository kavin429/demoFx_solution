<?php $__env->startSection('title', 'DemoFX Solution'); ?>
...
<p id="hero-text" class="gradient-text-small">Where strategy meets opportunity without limits</p>
  ...
  <div class="hero-image scroll-animate">
    <img src="<?php echo e(asset('pics/test.png')); ?>" alt="Trading Illustration">
  </div>
</section>
...
<section class="about">
  ...
  <div class="about-coins">
    <img src="<?php echo e(asset('pics/img1.png')); ?>" alt="coin">
    <img src="<?php echo e(asset('pics/img2.png')); ?>" alt="coin">
    <img src="<?php echo e(asset('pics/img3.png')); ?>" alt="coin">
...
<div class="about-info">
  <div class="about-grid">
    ...
    <div class="about-image">
      <img src="<?php echo e(asset('pics/about1.png')); ?>" alt="About ITrade Solutions LTD">
    </div>
 ...
 <div class="about-text">
  ...
  <a href="<?php echo e(route('about')); ?>" class="about-btn">More About Us</a>
</div>
...
<section id="products">
  ...
  <div class="products-bg">
   <img src="<?php echo e(asset('pics/coin4 (1).png')); ?>" alt="Trading Icon 1">
   <img src="<?php echo e(asset('pics/coin5 (2).png')); ?>" alt="Trading Icon 2">
   <img src="<?php echo e(asset('pics/coin6 (3).png')); ?>" alt="Trading Icon 3">
  ...
  <div class="products-slider">
    <div class="product-card">
      ...
      <a href="<?php echo e(route('forex')); ?>" class="arrow-link">Learn More</a>
    </div>
    <div class="product-card">
      ...
      <a href="<?php echo e(route('metals')); ?>" class="arrow-link">Learn More</a>
    </div>
    <div class="product-card">
      ...
      <a href="<?php echo e(route('indices')); ?>" class="arrow-link">Learn More</a>
    </div>
    <div class="product-card">
      ...
      <a href="<?php echo e(route('crypto')); ?>" class="arrow-link">Learn More</a>
    </div>
...
<?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <article class="pricing-card <?php if($loop->last): ?> highlight-card <?php endif; ?>">
      <div class="price">$<?php echo e(number_format($plan->price, 0)); ?></div>
      <h3><?php echo e($plan->name); ?></h3>
      <ul>
        <li>Leverage <?php echo e($plan->leverage); ?></li>
        <li>Min lot size <?php echo e($plan->min_lot_size); ?></li>
        <li>Starting from <?php echo e($plan->starting_pips); ?> pips</li>
        <li><?php echo e($plan->swap); ?></li>
        <li>Commission <?php echo e($plan->commission); ?>%</li>
        <li><?php echo e($plan->spread); ?></li>
      </ul>
    ...
    <div class="testimonial-track">
      ...
      <div class="testimonial-card">
        <div class="client-top">
          <img src="<?php echo e(asset('pics/client2.jpg')); ?>" alt="Daniel Thompson">
      ...
      <div class="testimonial-card">
        <div class="client-top">
          <img src="<?php echo e(asset('pics/client.webp')); ?>" alt="Fatima Hassan">
          <h4>Fatima Hassan</h4>
      ...
      <div class="testimonial-card">
        <div class="client-top">
          <img src="<?php echo e(asset('pics/client3.webp')); ?>" alt="Rahul Mehta">
          <h4>Rahul Mehta</h4>
      ...
      <div class="testimonial-card">
        <div class="client-top">
          <img src="<?php echo e(asset('pics/client1.avif')); ?>" alt="Olivia Martinez">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\demo_solutions\resources\views/home.blade.php ENDPATH**/ ?>